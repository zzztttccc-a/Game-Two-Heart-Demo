...
public class PlayerData
{
    ...
    public bool seenFocusTablet; //�Ƿ񿴵�����ʾFocus��Ѫ��ʯ��
    public bool promptFocus; //�Ƿ��ǵ�һ�ΰ�Focus��Ѫ����֮ǰ
    public int maxMP; //���MP����
    public int MPCharge; //MP������
    public int MPReserve; //�����MP
    public int MPReserveMax; //��������MP
    public bool soulLimited; //�Ƿ����������������(��˼��������˺����������һ��)
    ...
    public int fireballLevel;//法球等级，0表示没有
    [FormerlySerializedAs("quakeLevel")]
    public int stasisLevel;//静止术等级，0表示没有
    ...
    public bool gotCharm_24; //����̰��
    public bool equippedCharm_24;
    public bool brokenCharm_24; //����̰������
    ...
    // 映射旧字段名到新的名称（Stasis、Eye），避免 PlayMaker 或其他字符串访问的破坏。
