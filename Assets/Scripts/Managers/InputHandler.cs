...
public class InputHandler : MonoBehaviour
{
    ...
    public delegate void CursorVisibilityChange(bool isVisible); //ָ����ʾ�仯ʱ������ί��
    public event CursorVisibilityChange OnCursorVisibilityChange;//ָ����ʾ�仯ʱ�������¼�
	...
	switch (skipMode)
	{
	    case SkipPromptMode.SKIP_PROMPT: //ȷ����������
		...
		return;
	    case SkipPromptMode.NOT_SKIPPABLE_DUE_TO_LOADING: //�ڹ�����Ƶ���ص�ʱ��׼��������
		gm.ui.ShowCutscenePrompt(CinematicSkipPopup.Texts.Skip);
		CancelInvoke("StopCutsceneInput");
		Invoke("StopCutsceneInput", 5f * Time.timeScale);
		break;
